package com.heli.packet;

import com.heli.attribute.RadiusAttribute;
import com.heli.attribute.VendorSpecificAttribute;
import com.heli.dictionary.AttributeType;
import com.heli.dictionary.Dictionary;
import com.heli.exception.RadiusException;
import com.heli.util.RadiusUtil;
...
public class RadiusPacket {
	...
	public List<RadiusAttribute> getAttributes(int attributeType) {
		...
		for (Object attribute : attributes) {
			RadiusAttribute a = (RadiusAttribute) attribute;
	...
	public List<RadiusAttribute> getAttributes(int vendorId, int attributeType) {
		...
		for (RadiusAttribute radiusAttribute : vsas) {
	 ...
	 *                malformed packet
	 */
	public RadiusPacket decodeRequestPacket(InputStream in, String sharedSecret) throws IOException, RadiusException {
		return decodePacket(dictionary, in, sharedSecret, null);
	}

	public RadiusPacket decodeRequestPacket(InputStream in, String sharedSecret, int forceType) throws IOException, RadiusException {
		return decodePacket(dictionary, in, sharedSecret, null, forceType);
	}
	 ...
	 *                malformed packet
	 */
	public RadiusPacket decodeResponsePacket(InputStream in, String sharedSecret, RadiusPacket request) throws IOException, RadiusException {
		if (request == null)
	 ...
	 *                malformed packet
	 */
	public RadiusPacket decodeRequestPacket(Dictionary dictionary, InputStream in, String sharedSecret) throws IOException, RadiusException {
		return decodePacket(dictionary, in, sharedSecret, null);
	}
	 ...
	 *                malformed packet
	 */
	public RadiusPacket decodeResponsePacket(Dictionary dictionary, InputStream in, String sharedSecret, RadiusPacket request)
	 ...
	 */
	public RadiusPacket createRadiusPacket(final int type) {
		RadiusPacket rp;
		switch (type) {
			case ACCESS_REQUEST:
	 ...
	 */
	protected RadiusPacket decodePacket(Dictionary dictionary, InputStream in, String sharedSecret, RadiusPacket request) throws IOException,
		RadiusException {
		return decodePacket(dictionary, in, sharedSecret, request, UNDEFINED);
	}
	
	public RadiusPacket decodePacket(Dictionary dictionary, InputStream in,
